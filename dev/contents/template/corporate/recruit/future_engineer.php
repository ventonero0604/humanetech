...
<div id="wrapper" class="Page_wrapper">
  ...
  <main>
    <section class="Corporate">
      <div class="Corporate__main Corporate__main--future FlexBox FlexBox--middle">
        <h1 class="Corporate__title"><img src="/src/asset/corporate/title-future.png" alt="未来のエンジニア採用" /></h1>
      </div>
  
      <div class="LocalNavi">
        <ul class="LocalNavi__list LocalNavi__list--future">
          <li class="LocalNavi__listItem"><a class="LocalNavi__listLink" href="../../future_engineer/">未来のエンジニア採用</a></li>
          <li class="LocalNavi__listItem"><a class="LocalNavi__listLink" href="../../future_engineer/staff.php">社員紹介</a></li>
          <li class="LocalNavi__listItem"><a class="LocalNavi__listLink" href="../welfare.php">教育制度・福利厚生</a></li>
          <li class="LocalNavi__listItem"><a class="LocalNavi__listLink" href="../recruit/">募集要項</a></li>
          <li class="LocalNavi__listItem"><a class="LocalNavi__listLink" href="../../engineer_dispatch/faq.php">よくある質問</a></li>
          <li class="LocalNavi__listItem"><a class="LocalNavi__listLink is-current">採用エントリー</a></li>
        </ul>
      </div>

      <div class="Corporate__wrapper Corporate__wrapper--red">
        <div class="RoundWrapper">
          ...
          <div class="RoundWrapper__contents">
            <ul class="Corporate__list">
              <li class="Corporate__listItem FlexBox">
                <div class="Corporate__listTitle">
                  募集概要
                </div>
                <div class="Corporate__listText">
                  開発エンジニア / ネットワークエンジニア / サーバーエンジニア
                </div>
              </li>
              <li class="Corporate__listItem FlexBox">
                <div class="Corporate__listTitle">
                ...
                <div class="Corporate__listText">
                  <p><a href="#">●サーバーエンジニア</a></p>
                  <p>インフラ設計・構築業務及び導入後の運用設計、運用、監視</p>
                  <p><a href="#">●ネットワークエンジニア</a></p>
                  <p>ネットワーク設計・構築業務及び導入後の運用設計、運用、監視</p>
                  <p><a href="#">●開発エンジニア</a></p>
                  <p>システム基本設計、詳細設計、開発、テスト、運用</p>
                </div>
              </li>
              <li class="Corporate__listItem FlexBox">
                <div class="Corporate__listTitle">
              ...
              <li class="Corporate__listItem FlexBox">
                ...
                <div class="Corporate__listText">
                  <p>●休日／完全週休 2日制（土・日）、祝日</p>
                  <p>●休暇／夏季休暇、年末年始休暇、有給休暇、慶弔休暇、バースデー休暇</p>
                </div>
              </li>
              <li class="Corporate__listItem FlexBox">
                <div class="Corporate__listTitle">
                ...
                <div class="Corporate__listText">
                  社会保険完備（東京都情報産業サービス健康保険組合（TJK）加盟）／健康診断／キャリアコンサルティング／社員旅行／大手フィットネスクラブの優待会員など国内約2000軒のホテル・旅館、全国850箇所のレジャー施設、各種サービスをご利用可能詳しくは<a class="underLine" href="../welfare.php">教育制度・福利厚生のページ</a>へ
                </div>
              </li>
              <li class="Corporate__listItem FlexBox">
                <div class="Corporate__listTitle">
                ...
                <div class="Corporate__listText">
                  マネジメント研修、技術研修詳しくは<a class="underLine" href="../../future_engineer/">エンジニア育成のページ</a>へ
                </div>
              </li>
            </ul>
          </div>
        ...
        <div class="RoundWrapper">
          ...
          <div class="Form RoundWrapper__contents">
            <form>
              <div class="Form__items Form__items--check">
                <div class="FlexBox Form__checkContainer--sp">
                  <p class="Form__label Form__label--check">希望職種<b>※</b></p>
                  <div class="FlexBox Form__checkContainer--sp">
                    <div class="Form__checkWrapper--1col FlexBox FlexBox--middle">
                      <input class="Form__check" type="checkbox" name="" />
                      <label class="Form__checkText">サーバー<br>エンジニア</label>
                    </div>
                    <div class="Form__checkWrapper--1col FlexBox FlexBox--middle">
                      <input class="Form__check" type="checkbox" name="" />
                      <label class="Form__checkText">ネットワーク<br/>エンジニア</label>
                    </div>
                    <div class="Form__checkWrapper--1col FlexBox FlexBox--middle">
                      <input class="Form__check" type="checkbox" name="" />
                      <label class="Form__checkText">開発エンジニア</label>
                    </div>
                    <div class="Form__checkWrapper--1col FlexBox FlexBox--middle">
                      <input class="Form__check" type="checkbox" name="" />
  ...
  <div class="BreadCrumb">
    <div class="BreadCrumb__wrapper">
      <div class="FlexBox FlexBox--middle">
        ...
        <a class="BreadCrumb__item" href="../">採用情報</a>
        <p class="BreadCrumb__item">未来のエンジニア採用 募集要項・エントリー</p>
      </div>
    </div>
  </div>
